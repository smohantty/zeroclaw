...
/// Structured diagnostic result for programmatic consumption through the API.
...
/// Run diagnostics and return structured results for the API.
...
mod tests {
    ...
    fn provider_validation_checks_custom_url_shape() {
        assert!(provider_validation_error("openai").is_none());
