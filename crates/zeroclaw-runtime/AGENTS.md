...
Do not add new functionality here. The RFC's Phase 2-4 roadmap defines the decomposition plan: agent loop, gateway, channels orchestrator, daemon, cron, security, observability, TUI, skills, and doctor will each be extracted into dedicated crates or converted to WASM plugins.
