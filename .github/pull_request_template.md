...
- If `Yes`, locale navigation parity updated in `README*`, `docs/README*`, and `docs/SUMMARY.md` for supported locales (`en`, `ko`)? (`Yes/No`)
- If `Yes`, Korean runtime-contract docs updated where equivalents exist? (`Yes/No/N.A.`)
